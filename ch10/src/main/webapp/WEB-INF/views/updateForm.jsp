	...
	<div class="container" align="center">
		...
		<form action="${path}/update" method="post" name="frm" onsubmit="return chk()">
			...
			<table class="table table-bordered">
				<tr>
					<td>제목</td>
					<td><input type="text" name="subject" required="required" autofocus="autofocus" value="${board.subject }"></td>
				</tr>
				<!--회원게시판에서는 사용안하고 id나 회원이름으로 대체 회원 게시판 에서는 login하지 않으면 조회는 가능하지 만 입력/수정/삭제는 못하게 한다 -->
				<tr>
					<td>작성자</td>
				...
				<tr>
					<td colspan="2" align="center"><input type="submit" value="확인" class="btn btn-warning">
			</table>
		</form>
	</div>
</body>
